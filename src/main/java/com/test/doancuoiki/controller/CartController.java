package com.test.doancuoiki.controller;

import com.test.doancuoiki.entity.Product;
import com.test.doancuoiki.service.ProductService;
...
public class CartController {
    ...
    @Autowired
    public CartController(ShoppingService shoppingCartService, ProductService productService) {
