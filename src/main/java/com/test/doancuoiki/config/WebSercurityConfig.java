package com.test.doancuoiki.config;

import com.test.doancuoiki.repository.UserRepository;
import com.test.doancuoiki.service.impl.UserDetailsServiceImpl;
...
public class WebSercurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    public WebSercurityConfig(UserRepository userRepository) {
